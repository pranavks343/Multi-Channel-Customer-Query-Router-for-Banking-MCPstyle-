...
CANNED_RESPONSES = [
    {
        ...
        "keywords": ["verification stuck", "pending", "account verification", "kyc pending", "vendor account", "bank account verification"],
    ...
    },
    {
        ...
        "keywords": ["403", "forbidden", "api error", "authentication failed", "api integration", "payment data"],
    ...
    },
    {
        ...
        "keywords": ["invoice", "charge", "billing", "extra charge", "overcharge", "monthly invoice", "discrepancy"],
    ...
    },
    {
        ...
        "keywords": ["payment not received", "transfer not showing", "missing payment", "balance not updated"],
    ...
    },
    {
        ...
        "keywords": ["webhook", "callback", "notification not received", "event not triggering"],
    ...
    },
    {
        ...
        "keywords": ["compliance", "gdpr", "pci dss", "soc 2", "audit", "certification"],
    ...
    },
    {
        ...
        "keywords": ["demo", "pricing", "enterprise plan", "partnership", "white label"],
    ...
    },
    {
        ...
        "keywords": ["identity verification", "id verification", "document verification", "verification failing"],
    ...
    },
    {
        ...
        "keywords": ["down", "not working", "500 error", "504 error", "timeout", "outage"],
